...
import { LeadMagnet, Profile } from "@/lib/generated/prisma";
...
function LeadMagnetView({ leadMagnet, profile }: LeadMagnetViewProps) {
  return (
    <div className="mb-10 flex flex-1 max-h-[100vh] flex-col overflow-y-scroll rounded-lg bg-white p-4 shadow-lg md:mb-0 md:p-8 ">
