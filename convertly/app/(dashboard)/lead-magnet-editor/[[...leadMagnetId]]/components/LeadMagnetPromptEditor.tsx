   ...
   return (
    <div className="flex h-full flex-row">
      <div className="m-8 flex w-1/2 flex-col">
        <h1 className="mb-4 w-fit bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-3xl font-bold text-transparent">
          AI Prompt Editor 🪄
        </h1>
        <div className="mb-4">
          ...
          <textarea
            ...
            placeholder="Ex. Give me 5 business that will make me money in 2026..."
            rows={15}
            onChange={(e) =>
        ...
        <div className="mb-4">
          ...
          <textarea
            placeholder="Type your subtitle of Lead Magnet here..."
            rows={2}
            className="w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none"
